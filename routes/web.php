...
Route::get('/store', 'MemosController@store')->name('store');
Route::get('/edit', 'MemosController@edit')->name('edit');
Route::post('/edit', 'MemosController@edit')->name('edit');
Route::get('/update', 'MemosController@update')->name('update');
Route::post('/update', 'MemosController@update')->name('update');
Route::get('/delete', 'MemosController@delete')->name('delete');
Route::post('/delete', 'MemosController@delete')->name('delete');